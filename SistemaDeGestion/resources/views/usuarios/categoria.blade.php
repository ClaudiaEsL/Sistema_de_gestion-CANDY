...
<div class="container">
  <div class="content-table">
      <div style="width:700px;margin-bottom:5%;">
            <h5 class="btn-primary" style="padding:1%">Lista de categorias</h5>
            <table class="table table-striped">
                ...
                <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td>Verduras congelas</td>
                            <td>Variedad de verduras cortadas y reservadas</td>
                            <td>
      ...
      <div class="formulario" style="width:700px;margin-bottom:5%;">
        <div class="contenido-alineado ">
            <form action="" method="POST">
                    <h5 class="btn-primary" style="padding:1%">Registrar nueva categoria</h5>
